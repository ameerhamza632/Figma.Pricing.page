  ...
  return (
    <Box pt="150px" pb="32px">
      <Flex
        ...
        maxW="70%"
      >
        <Feature icon={MoneyBackGuranteeIcon} color='#8186D5'>
          30 days money back Guarantee
        </Feature>
        <Feature icon={HasleFreeIcon} color='#8186D5'>No setup fees 100% hassle-free</Feature>
        <Feature icon={MonthlySubscriptionIcon} color='#8186D5'>
